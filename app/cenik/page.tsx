    ...
    <main className="bg-white min-h-screen text-slate-800 antialiased selection:bg-[#73C2BE]/30">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto">
        <div className="grid gap-8 md:grid-cols-3 items-stretch">
          ...
          <div className="rounded-2xl border-2 border-[#73C2BE] p-8 bg-white flex flex-col justify-between shadow-lg relative transform md:scale-[1.03] transition-all group">
            <div className="space-y-6">
              <div className="space-y-2">
                <span className="text-xs font-bold text-[#2986BF] uppercase tracking-widest block">Pro nováčky</span>
                <h3 className="text-2xl font-black text-[#1E388C] uppercase">1 Trénink na zkoušku</h3>
              ...
              <div className="flex items-baseline gap-1 py-2 border-t border-b border-slate-100">
                <span className="text-4xl font-black text-[#1E388C]">790</span>
                <span className="text-m font-bold text-[#1E388C]">Kč / lekce</span>
              </div>
            ...
            <div className="pt-8">
              <Link 
                href="/rezervace" 
                className="block w-full rounded-xl border-2 border-[#73C2BE] bg-white py-3 px-4 text-center text-sm font-bold text-[#1E388C] hover:bg-[#1E388C] hover:text-white transition-all uppercase tracking-wider"
              >
                Vyzkoušet EMS
              </Link>
            </div>
          ...
          <div className="rounded-2xl border-2 border-[#2295d3] p-8 bg-white flex flex-col justify-between shadow-lg relative transform md:scale-[1.03] transition-all group">
            <span className="absolute -top-3.5 left-6 rounded-full bg-[#2295d3] text-white px-4 py-1 text-[11px] font-black uppercase tracking-widest shadow-md flex items-center gap-1">
              <Sparkles size={12} className="text-[#ffffff]" /> Nejoblíbenější
            </span>
            <div className="space-y-6">
              <div className="space-y-2">
                <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block">Pro </span>
              ...
              <div className="flex items-baseline gap-1 py-2 border-t border-b border-slate-100">
                <span className="text-4xl font-black text-[#1E388C]">690</span>
                <span className="text-m font-bold text-[#1E388C]">Kč / lekce</span>
                <span className="text-xs text-[#2986BF] font-bold ml-2">6 900 Kč</span>
              </div>
            ...
            <div className="pt-8">
              <Link 
                href="/rezervace" 
                className="block w-full rounded-xl border-2 border-[#2295d3] bg-white py-3 px-4 text-center text-sm font-bold text-slate-600 hover:bg-[#1E388C] hover:text-white transition-all uppercase tracking-wider"
              >
                Koupit 10 lekcí
              </Link>
            </div>
          ...
          <div className="rounded-2xl border-2 border-[#1E388C] p-8 bg-white flex flex-col justify-between shadow-lg relative transform md:scale-[1.03] transition-all group">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h3 className="text-2xl font-black text-[#1E388C] uppercase">Permanentka 20 vstupů</h3>
                <p className="text-xs text-slate-500">Intenzivní program pro redukci tuku a konec bolesti zad.</p>
              </div>
              
              <div className="flex items-baseline gap-1 py-2 border-t border-b border-slate-100">
                <span className="text-4xl font-black text-[#1E388C]">640</span>
                <span className="text-m font-bold text-[#1E388C]">Kč / lekce</span>
                <span className="text-xs text-[#2986BF] font-bold ml-2">12 800 Kč</span>
              </div>
              ...
              <ul className="space-y-3 text-sm text-slate-700 font-medium">
                <li className="flex items-start gap-2.5">
                  ...
                  <Check size={16} className="text-[#1E388C] shrink-0 mt-0.5" />
                  <span>20x plnohodnotný 20minutový EMS trénink</span>
                </li>                
                <li className="flex items-start gap-2.5">
                  <Check size={16} className="text-[#1E388C] shrink-0 mt-0.5" />
        ...
        <div className="space-y-6">
          <div className="p-6 bg-white rounded-xl border border-slate-200/60 space-y-2">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Platby v našem studiu ve Znojmě momentálně probíhají na místě v hotovosti. Pokud potřebujete vystavit fakturu pro vašeho zaměstnavatele, napište nám prosím předem a rádi vám doklad vystavíme.
            </p>
          </div>

          <div className="p-6 bg-white rounded-xl border border-slate-200/60 space-y-2">
            <h4 className="font-bold text-[#1E388C] flex items-center gap-2 text-base">
              Jaká je platnost permanentky na 10 a 20 vstupů?
            </h4>
            <p className="text-sm text-slate-600 leading-relaxed">
              Platnost permanentky jsou 4 měsíce pro 10 vstupů a 6 měsíců pro 20 vstupů od data nákupu. To vám dává dostatečnou flexibilitu i v případě dovolené nebo krátkodobé nemoci.
            </p>
          </div>
